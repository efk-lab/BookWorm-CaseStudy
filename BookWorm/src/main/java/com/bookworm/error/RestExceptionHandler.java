...
//    }
    ...
    /**
     * Handle ValidationException, handle  ValidationException.class
     *
     * @param ex the Exception
     * @return the ApiError object
     */
    @ExceptionHandler(BookWormException.class)
    protected ResponseEntity<Object> handleBookWormException(BookWormException ex,
                                                                      WebRequest request) {
