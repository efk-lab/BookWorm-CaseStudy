...
public class ServerSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public ServerSecurityConfiguration(BookWormAuthenticationEntryPoint customAuthenticationEntryPoint, @Qualifier("userService") UserDetailsService userDetailsService) {
